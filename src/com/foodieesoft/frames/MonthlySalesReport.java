...
import static com.foodieesoft.frames.todaysSaleReport.user_id;
...
public class MonthlySalesReport extends javax.swing.JFrame {
    ...
    public MonthlySalesReport(String username) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 1170, 410));
        ...
        jPanel1.add(jTextFieldSerachProducts, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 40, 240, 20));
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 40, -1, -1));
        ...
        jButtonSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/geeks/foodieesoft/images/pdf.png"))); // NOI18N
        jButtonSave.setText("Save as pdf");
        jButtonSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonSaveActionPerformed(evt);
            }
        });
        jPanel1.add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 250, 50));
        ...
        jLabel10.setText("Monthly Sale Report");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        MessageFormat header = new MessageFormat("Foodiee Soft Monthly Sale Report");
    ...
    public void showInTable() {
        ...
        order_list = orderDAO.getAllOrderOfMonth();
    ...
    public void genMonthlyReport() {
        ...
        String report_name = "Report of Monthly sale ";

        File f = new File("Reports\\MonthlySaleReports/" + report_name + ".pdf");
        if (f.exists()) {
            f.delete();
        }
        try {
            ...
            String rpath = "reprotFiles/monthlySale.rptdesign";
...
//            // int order=DbManager.getMaxOrder();
            ...
            options.setOutputFileName("Reports\\MonthlySaleReports/" + report_name + ".pdf");
            ...
            try {
                ...
                if ((new File("Reports\\MonthlySaleReports/" + report_name + ".pdf")).exists()) {

                    Process p = Runtime
                            .getRuntime()
                            .exec("rundll32 url.dll,FileProtocolHandler Reports\\MonthlySaleReports/" + report_name + ".pdf");
                    p.waitFor();
